            ...
            <main>
                <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Dashboard/Update Color</li>
                        </ol>
                
                    <form role="form" action="/updatecolor/{{ $id }}" method="post">
                    @csrf
                        <div class="form-group row">
                            <label class="col-xl-3">Color Name<i class="text-danger">*</i></label>
                            <div class="form-group">
                                <div class="col-xs-7">
                                    <input name="color" value="{{ $cnm }}" type="text" class="form-control" id="category_name" placeholder="Male/Female" required>
                                </div>
                            </div>
                        </div>
