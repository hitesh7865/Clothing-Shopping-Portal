        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid">
                        <h1 class="mt-4">View Color</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Dashboard/View Color</li>
                        </ol>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>{{ $c->color }}</td>
                                        <td><a href="click_edit_color/{{ $c->id }}" class="btn btn-lg btn-success">Edit</a></td>
                                        <td><a href="click_delete_color/{{ $c->id }}" class="btn btn-lg btn-danger">Delete</a></td>
                                    </tr>
                                    <?php 
                                    }
                                    ?>
