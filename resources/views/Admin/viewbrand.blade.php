            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Dashboard/View Brand</li>
                        </ol>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>{{ $c->Brand_name }}</td>
                                        <td><a href="click_edit_brand/{{ $c->id }}" class="btn btn-lg btn-success">Edit</a></td>
                                        <td><a href="click_delete_brand/{{ $c->id }}" class="btn btn-lg btn-danger">Delete</a></td>
                                    </tr>
                                    <?php 
                                    }
                                    ?>
