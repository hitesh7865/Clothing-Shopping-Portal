            ...
            <main>
                <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Dashboard/Update Category</li>
                        </ol>
                
                    <form role="form" action="/update/{{ $id }}" method="post">
                    @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group">
                                <div class="col-xs-7">
                                    <textarea class="textarea" placeholder="Place some text here" name="Discription" style="width: 300%; height: 150px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required>{{ $disc }}</textarea>
                                </div>
                            </div>
                        </div>
