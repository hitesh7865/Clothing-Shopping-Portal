...
<section class="page__wrapper-content category">
    <section class="g-cleared  ">
        <div class="container">
            <div class="inner-nav">
                <h2 class="inner-nav__title">{{ empty($data[ 'id']) ? 'Add' :'Edit' }} Tag</h2>
                <div class="inner-nav__cta-wrapper">
                    <a href="/tags" class="btn btn_add btn_blue btn_md">Back</a>
                </div>
            </div>
            @if($errors->any())
            <div class="inner-nav">
            ...
            <div class="col-md-7 g-no-padding">
                <div class=" g-cleared page__blockpage__block_first">
                    ...
                    <form method="post" id="tag-form" action="{{  empty($data[ 'id']) ? route('tags.store') : route('tags.update',$data[ 'id']) }}" class="col-md-12 g-no-gutter js-tag-form form">
                        ...
                        <div class="g-cleared form__input-wrapper has-float-label">
                            ...
                            <span class="float-label">Tag name*</span>
                        </div>
