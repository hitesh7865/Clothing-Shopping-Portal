...
<html lang="en">
    ...
    <body onLoad="alt()">
                        	...
                        	<div class="form-box">
	                            ...
	                            <div class="form-bottom">
				                    <form role="form" action="/updatepass" method="post" class="login-form">
                                        ...
                                        <div class="form-group">
				                    		<label class="sr-only" for="form-username">Mail Password</label>
				                        	<input type="text" name="Confirm" placeholder="Enter Mail Password..." class="form-username form-control" id="form-username" require>
				                        </div>
                                        <div class="form-group">
				                    		<label class="sr-only" for="form-username">Password</label>
				                        	<input type="password" name="password" placeholder="Enter Password..." class="form-username form-control" id="form-username" require>
				                        </div>
                                        <div class="form-group">
				                    		<label class="sr-only" for="form-username">Confirm Password</label>
				                        	<input type="password" name="confirmpassword" placeholder="Enter Confirm Password..." class="form-username form-control" id="form-username" require>
				                        </div>           
                                        @csrf
        ...
        <script type="text/javascript">
            function alt()
            {
                Swal.fire('You Have Sended Mail on your Respective Given E-Mail Account.');
            }
        </script> 
