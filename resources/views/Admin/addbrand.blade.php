            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid">
                    ...
                    @csrf
                        <div class="form-group row">
                            ...
                            <div class="form-group">
                                <div class="col-xs-7">
                                    <input name="brand_name" type="text" class="form-control" id="category_name" placeholder="Nike/Rebook" required>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="text-right"> 
                        <a href="/view-brand"><input type="submit" style="background-color:purple" class="btn btn-lg btn-success" name="View" value="View Brand"/></a>
                    </div>
                </div>
                </main>
