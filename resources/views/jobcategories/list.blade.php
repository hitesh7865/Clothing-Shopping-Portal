...
<section class="page__wrapper-content category">
    ...
    <section class="g-cleare ">
        <div class="container">
            <div class="inner-nav">
                <h2 class="inner-nav__title">Job Categories</h2>
                <div class="inner-nav__cta-wrapper">
                    <a href="/job-categories/create" class="btn btn_add btn_blue btn_md">Add</a>
                </div>
            </div>
            <div class="">
                <div class=" g-cleare">
                    <table id="job-categories-listing" class="js-job-categories-listing datatable row-border cell-border hover order-column stripe">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Action</th>
