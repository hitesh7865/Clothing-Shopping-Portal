            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Dashboard/Add Sub-Category</li>
                        </ol>
                
                
                    <form role="form" action="add_subcategory" method="post">
                    @csrf
                        <div class="form-group row">
                            <label class="col-xl-3">Sub-Category Name<i class="text-danger">*</i></label>
                            <div class="form-group">
                                <div class="col-xs-7">
                                    <input name="SubCategory_name" type="text" class="form-control" id="subcategory_name" placeholder="Shirt/T-Shirt/Pant" required>
                                </div>
                            </div>
                        </div>
