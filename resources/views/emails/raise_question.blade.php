                                                ...
                                                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;font-size:14px;">

                                                                Hello there,<br> Thank you for your application.
                                                                <br /> Before we proceed further, We would
                                                                like to ask you few questions to make
                                                                the screening process smoother:
                                                                <br />
                                                                <br /> Please help us by filling the form
                                                                <a href="{{$config['link']}}">here</a>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
