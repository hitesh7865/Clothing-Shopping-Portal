                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                <h1>Hello {{ $fullname }},<br>
                                                                    <span style="font-size:13px">A good start indeed, thank you for signup up.</span></h1> You are Awesome!
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <a href="{{ route('password.reset', $token) }}">Please reset Your Password</a>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                <!--[if mso]>
